...
\overline{\Delta t},
$$
where Fnet is the net external force, p is the change in momentum, and t is the change in time. We can solve for p by rearranging the equation
$$
\Delta \mathbf{p}
$$
$\mathbf{F}_{\text {net }}=$
