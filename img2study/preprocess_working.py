...
def main():
    if len(sys.argv) < 2:
        print("Usage: python preprocess_working.py <image_path>")
        sys.exit(1)
    ...
    # Keep DLA output as-is - it already has proper formatting
    # The dla_processor.py handles all formatting including table cleanup
    import re
    ...
    # 1. Save full JSON with all extraction data
    ...
    # 5. Save OCR cache for live demo
